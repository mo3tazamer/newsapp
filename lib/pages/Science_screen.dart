  ...
  Widget build(BuildContext context) {
    return BlocBuilder<NewscubitCubit, NewscubitState>(
      builder: (context, state) {
        List<Article>? news = BlocProvider.of<NewscubitCubit>(context).Science;
        if (state is sciencecubitloading) {
          return const Center(child: CircularProgressIndicator());
        } else if (state is sciencecubitsucsess) {
        ...
        } else if (state is sciencecubitfailure) {
          {
            return Center(
                child: Column(
